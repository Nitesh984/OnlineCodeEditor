...
const Landing = () => {
  ...
  useEffect(() => {
    defineTheme("sunburst").then((_) =>
      setTheme({ value: "sunburst", label: "Sun Burst" })
    );
  }, []);
  ...
  return (
    <>
      <ToastContainer
        ...
        pauseOnHover
      />
      <div className="flex flex-row " id="main_header">
      <div className="px-4 py-2" id="Logo">
            <img src={require('../images/Mainlogo2.png')} alt="Logo"></img>
        </div>
         <div className="flex float-right" id="header">
      ...
      <div className="flex flex-row space-x-4 items-start px-4 py-4">
        ...
        <div className="right-container flex flex-shrink-0 w-[30%] flex-col">
          ...
          <div className="flex flex-col items-end">
            ...
            >
              <image src={require('../images/Icone.png')} alt="Button Image"/>
              {processing ? "Please Wait...." : "Build & Run"}
            </button>
          </div>
